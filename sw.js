...
const STATIC = [
  ...
  './css/english.css',
  './css/styles.css',
  // JS — módulos da aplicação (URLs com ?v=999 para forçar atualização de cache)
  './js/audio.js?v=999',
  './js/conquistas.js?v=999',
  './js/core.js?v=999',
  './js/dialoghi.js?v=999',
  './js/canzoni.js?v=999',
  './js/imitazione.js?v=999',
  './js/flashcards.js?v=999',
  './js/grammar.js?v=999',
  './js/heatmap.js?v=999',
  './js/onboarding.js?v=999',
  './js/profilo.js?v=999',
  './js/progression.js?v=999',
  './js/quiz.js?v=999',
  './js/quiz_data.js',
  './js/vocab.js?v=999',
  './js/i18n.js?v=999',
  './js/notificacoes.js?v=999',
  './js/tour.js?v=999',
  './js/storie.js?v=999',
  './js/ia-import.js?v=999',
  // Dados
