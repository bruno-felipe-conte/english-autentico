...
const I18n = {
  ...
  dict: {
    ...
    // ── Grammar — feedback ──
    'gram_conteudo_indisponivel': { pt: 'Conteúdo não disponível.', en: 'Conteúdo não disponível.' },
    'gram_placeholder_resposta': { pt: 'Digite sua resposta...', en: 'Digite sua resposta...' },
    'gram_por_que': { pt: 'Por quê?', en: 'Por quê?' },
    'gram_correto': { pt: 'Correto!', en: 'Correto!' },
    'gram_errado': { pt: 'Incorreto.', en: 'Incorreto.' },
    'gram_resposta_era': { pt: 'A resposta era:', en: 'A resposta era:' },
    'gram_por_que_importa': { pt: 'Por que isso importa?', en: 'Por que isso importa?' },
    'gram_arm_errado': { pt: 'Errado', en: 'Errado' },
    'gram_arm_certo': { pt: 'Certo', en: 'Certo' },
    ...
    'gram_fase2_label': { pt: '🔎 Fase 2: Observar e Descobrir', en: '🔎 Fase 2: Observar e Descobrir' },
    'gram_fase2_sub':   { pt: 'Clique nos cartões abaixo para descobrir regras e padrões de forma prática!', en: 'Clique nos cartões abaixo para descobrir regras e padrões de forma prática!' },
    'gram_fase3_label': { pt: '📋 Fase 3: Tabela de Referência Rápida', en: '📋 Fase 3: Tabela de Referência Rápida' },
    'gram_fase4_label': { pt: '🗣️ Fase 4: Analisar os Exemplos', en: '🗣️ Fase 4: Analisar os Exemplos' },
    'gram_fase4_sub':   { pt: 'Clique nos exemplos abaixo para praticar seu raciocínio antes de ver a resposta!', en: 'Clique nos exemplos abaixo para praticar seu raciocínio antes de ver a resposta!' },
    'gram_fase4_prc_pergunta': { pt: 'Pergunta', en: 'Pergunta' },
    'gram_fase4_prc_resposta': { pt: 'Resposta', en: 'Resposta' },
    'gram_fase4_prc_conclusao': { pt: 'Conclusão', en: 'Conclusão' },
    'gram_fase4_ver_detalhes': { pt: 'Ver detalhes ▾', en: 'Ver detalhes ▾' },
    'gram_fase5_label': { pt: '⚠️ Fase 5: Evitar Armadilhas Comuns', en: '⚠️ Fase 5: Evitar Armadilhas Comuns' },
    'gram_fase5_sub':   { pt: 'Erros comuns de quem está aprendendo e como evitá-los:', en: 'Erros comuns de quem está aprendendo e como evitá-los:' },
    'gram_fase5_porque': { pt: 'Por quê?', en: 'Por quê?' },
    'gram_inventario_label': { pt: '✅ O que você vai aprender', en: '✅ O que você vai aprender' },
    'gram_definicao_label': { pt: '🔍 Observar e entender', en: '🔍 Observar e entender' },
    'gram_def_veja':    { pt: 'Veja', en: 'Veja' },
    'gram_def_pense':   { pt: 'Pense', en: 'Pense' },
    'gram_def_entenda': { pt: 'Entenda', en: 'Entenda' },
    'gram_tecnica_label': { pt: '📌 Como usar na prática', en: '📌 Como usar na prática' },
    'gram_exemplos_prc_label': { pt: '🗣️ Veja os exemplos (clique em 🔊 para ouvir)', en: '🗣️ Veja os exemplos (clique em 🔊 para ouvir)' },
    'gram_ponte_label': { pt: '🇵🇹 Em português é assim… em inglês é assim:', en: '🇵🇹 Em português é assim… em inglês é assim:' },
    ...
    'gram_clique_revelar':   { pt: '👆 Clique nas palavras para revelar, ou clique em "Revelar resposta"', en: '👆 Clique nas palavras para revelar, ou clique em "Revelar resposta"' },
